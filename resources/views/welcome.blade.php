...
@section('content')
            ...
            <div class="swiper-wrapper">
                ...
                @foreach($categories as $category)
                    <div class="swiper-slide">
                        <a class="slider-category carousel-inner" role="listbox" href="{{route('category.posts',$category->slug)}}">
    ...
    <section class="blog-area section">
        <div class="container">
            ...
            <a class="load-more-btn" href="{{route('post.index')}}"><b>LEIA MAIS</b></a>
