                    ...
                    <div class="body">
                        <div class="form-group form-float">
                            <div class="form-line {{$errors->has('categories')? 'focused error' : ''}}">
                                ...
                                <select name="categories[]" id="category" class="form-control show-tick" data-live-search="true" multiple title="Selectionar Categoria ">
                    ...
                    <div class="body">
                        <div class="form-group form-float">
                            <div class="form-group">
                                ...
                                <a href="{{route('admin.category.index')}}" class="btn btn-danger waves-effect">
